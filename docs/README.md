...
| Doc | What it covers |
|-----|----------------|
| [../integrations/cowork/README.md](../integrations/cowork/README.md) | How Claude drives jobcut: the nine skills (jobcut front door · daily · score · review · track · add · open · market · update) and the CLI-as-database contract. |
